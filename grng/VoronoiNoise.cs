...
public class VoronoiNoise : Noise_t
{
    ...
    public VoronoiNoise(int seed, GRandomAlgorithms.AlgorithmChoices algo) : base(seed,algo)
	{
        this.displacement = 1.0f;
	}

    public VoronoiNoise(GRandomAlgorithms.AlgorithmChoices algo) : base(algo)
	{
        this.displacement = 1.0f;
	}
