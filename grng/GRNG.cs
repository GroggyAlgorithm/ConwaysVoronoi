...
public class GRNG
{
    ...
    public GRandomAlgorithms.AlgorithmChoices _selected_algo { get; protected set; }
    ...
    protected GRandomAlgorithms._randomAlgo _selectedAlgorithm;
    ...
    public void SetAlgorithm(GRandomAlgorithms.AlgorithmChoices newAlgorithm)
    {
        this._selected_algo = newAlgorithm;
        _selectedAlgorithm = GRandomAlgorithms.SelectAlgorithm(newAlgorithm);
    }
    ...
    public GRNG(GRNG grng)
    {
        ...
        _selectedAlgorithm = GRandomAlgorithms.SelectAlgorithm(this._selected_algo);
    }

    public GRNG(int seed, GRandomAlgorithms.AlgorithmChoices algo = GRandomAlgorithms.AlgorithmChoices.AdaptedLehmer32) 
    {
        this.seed = seed;
        _selectedAlgorithm = GRandomAlgorithms.SelectAlgorithm(algo);
    }

    public GRNG(float seed, GRandomAlgorithms.AlgorithmChoices algo = GRandomAlgorithms.AlgorithmChoices.AdaptedLehmer32) 
    {
        this.seed = seed.ToInt();
        _selectedAlgorithm = GRandomAlgorithms.SelectAlgorithm(algo);
    }

    public GRNG(long seed, GRandomAlgorithms.AlgorithmChoices algo = GRandomAlgorithms.AlgorithmChoices.AdaptedLehmer32) 
    {
        this.seed = (int)(seed);
        _selectedAlgorithm = GRandomAlgorithms.SelectAlgorithm(algo);
    }

    public GRNG(string seed, GRandomAlgorithms.AlgorithmChoices algo = GRandomAlgorithms.AlgorithmChoices.AdaptedLehmer32) 
    {
        this.seed = seed.GetHashCode();
        _selectedAlgorithm = GRandomAlgorithms.SelectAlgorithm(algo);
    }

    public GRNG(GRandomAlgorithms.AlgorithmChoices algo = GRandomAlgorithms.AlgorithmChoices.AdaptedLehmer32) 
    {
    ...
    {
        return (Range(0.0f, 1.0f) > 0.5 ? true : false);
    }
    ...
    /// <param name="strength"></param>
    /// <returns></returns>
    public float UpperBiasValue(float strength)
    {
    ...
    {
        long n = (NextInt() * x + NextInt() * y + this.seed * seed) & 0x7fffffff;
        n = (n >> 13) ^ n;
        return (n * (n * n * 60493 + 19990303) + 1376312589) & 0x7fffffff;
    }
    ...
    public float Voronoi(float x, float y, float z, float frequency, bool useDistance, float displacement)
    {
        return (float)(Voronoi((double)x, (double)y, (double)z, (double)frequency, useDistance, (double)displacement));
    }
    public float Voronoi(int x, int y, int z, float frequency, bool useDistance, float displacement)
    { 
        return (float)(Voronoi((double)x, (double)y, (double)z, (double)frequency, useDistance, (double)displacement));
    }


    public float Voronoi(float x, float y, float frequency, bool useDistance, float displacement)
    { 
        return (float)(Voronoi((double)x, (double)y, (double)frequency, useDistance, (double)displacement));
    }
    public float Voronoi(int x, int y, float frequency, bool useDistance, float displacement)
    {
        return (float)(Voronoi((double)x, (double)y, (double)frequency, useDistance, (double)displacement));
    }
    public float Voronoi(float x, float frequency, bool useDistance, float displacement) 
    {
        return (float)(Voronoi((double)x, (double)frequency, useDistance, (double)displacement));
    }
    public float Voronoi(int x, float frequency, bool useDistance, float displacement) 
    {
        return (float)(Voronoi((double)x, (double)frequency, useDistance, (double)displacement));
    }
