...
//public partial class PerlinNoise: INoise
//{
...
//    public PerlinNoise(INoise noiser) : base(noiser)
//    {
...
//        return gRand.Perlin1D(xPosition,randomPermTable)*amplitude;
//    }

//    public override float Sample2D(float xPosition, float yPosition, bool randomPermTable = false) {
//        if(amplitude == 0) amplitude = 1;
//        return gRand.Perlin2D(xPosition,yPosition,randomPermTable)*amplitude;
//    }

//    public override float Sample3D(float xPosition, float yPosition, float zPosition, bool randomPermTable = false) {
//        if(amplitude == 0) amplitude = 1;
//        return gRand.Perlin3D(xPosition,yPosition,zPosition,randomPermTable)*amplitude;
//    }
